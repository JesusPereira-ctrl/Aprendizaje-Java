public class Automovil implements Comparable<Automovil> {
    ...
    public String verDetalle() {
        String detalle = "auto.id = " + this.id +
                "\nthis.getFabricante = " + this.getFabricante() +
                "\nthis.getModelo = " + this.getModelo();

        if (this.getTipo() != null) {
            detalle += "\nthis.getTipo().getDescripcion() = " + this.getTipo().getDescripcion();
        }

        detalle += "\nthis.Color = " + this.color +
                "\nAutomovil.patenteColor = " + Automovil.colorPatente;

        if (this.motor != null) {
            detalle += "\nthis.motor.getCilindrada() = " + this.motor.getCilindrada();
        }
