public class EjemploAutomovilStatic {
    public static void main(String[] args) {
        ...
        System.out.println("Automóvil.VELOCIDAD_MAX_CARRETERA = " + Automovil.VELOCIDAD_MAX_CARRETERA);
        System.out.println("Automóvil.VELOCIDAD_MAX_CIUDAD = " + Automovil.VELOCIDAD_MAX_CIUDAD);
